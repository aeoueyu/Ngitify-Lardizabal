...
import styles from '../../styles/add-user/AddPatientPage.module.css'; // Uses Patient CSS
...
export default function AddPatientPage() {
    ...
    const handleGuardianChange = (e) => {
        const { name, value } = e.target;
        const field = name.split('_')[1]; // guardian_name -> name
        setFormData(prev => ({
            ...prev,
    ...
    // Render Address Helper (Same as others)
                ...
                <form onSubmit={handleSubmit} noValidate>
                    ...
                    <div className={styles.row}>
                        <div className={styles.formGroup}>
                            ...
                            {isMinor && <span style={{color: '#f57f17', fontSize: '12px', fontWeight: 'bold', marginTop: '5px'}}>Patient is under 13. Guardian details required.</span>}
                        </div>
            ...
            {showSuccessModal && (
                <div className={styles.modalOverlay}>
                    <div className={styles.modalCard}>
                        ...
                        <button className={styles.closeLink} onClick={() => navigate('/owner/manage-patients')}>Back to Manage Patients</button>
                    </div>
                </div>
            )}
        </div>
