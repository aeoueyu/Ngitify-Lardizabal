      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <input type="date" name="birthdate" value={formData.birthdate.split('T')[0]} onChange={handleChange} required className="p-2 border rounded" />
        ...
        <button type="submit" className="bg-blue-500 text-white px-4 py-2 rounded">Update Patient</button>
      </form>
    </div>
  );
}
