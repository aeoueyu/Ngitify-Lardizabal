...
import styles from '../styles/VerificationCodePage.module.css';
        ...
        <div className={styles['main-container']}>
            ...
            <div className={styles['container']}>
                <div className={styles['page-title']}>
                    <p className={styles['verify-title']}>Verify email address</p>
                </div>
                <div className={styles['page-header']}>
                    <p>Verification code has been sent to <strong>{userEmail}</strong></p>
                </div>
